...
export const fioByResult = (result: Result): string => {
  return `${result.last_name} ${result.first_name}`
}

export const universityByResult = (result: Result): string | undefined => {
...
export const labelByResultKey = (key: keyof Result): string => {
  switch (key) {
    case "last_name":
      return "Фамилия"
    case "first_name":
